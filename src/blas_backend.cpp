...
void BLASBackend::pseudo_inverse_svd(MatrixXc* matrix, const double alpha, MatrixXc* result) {
...
void BLASBackend::matrix_add(const double alpha, const MatrixX& a, const double beta, MatrixX* b) {
...
void BLASBackend::vector_add(const double alpha, const VectorX& a, const double beta, VectorX* b) {
  AUTD_AXPY(static_cast<int>(a.size()), alpha, a.data(), 1, b->data(), 1);
}
